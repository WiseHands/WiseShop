...
public class ShoppingCartDTO extends GenericModel {
    ...
    public void formatObject() {
        ...
        DeliveryCourierConfiguration courier =
                new DeliveryCourierConfiguration(shop.delivery.courierText, shop.delivery.isCourierAvailable, shop.delivery.courierFreeDeliveryLimit, shop.delivery.courierPrice, shop.delivery.minimumOrderTotalAmount);
