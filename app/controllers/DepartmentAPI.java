...
public class DepartmentAPI extends AuthController  {
    ...
    public static void update(String client, String uuid, String shopName, String shopAddress, String shopMail, String shopPhone, String destinationLat, String destinationLng) throws Exception {
        ShopDTO shop = ShopDTO.find("byDomain", client).first();
        if (shop == null) {
            shop = ShopDTO.find("byDomain", "localhost").first();
        }
