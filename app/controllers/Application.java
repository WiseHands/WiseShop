...
public class Application extends Controller {
    ...
    public static void index(String client) {
        ...
        if (isGoogleCrawler) {
            System.out.println(dateFormat.format(date) + ": Escaped Fragmen " + request.params.data.get("_escaped_fragment_")[0] + " request with ip " + ip +  " and user-agent " + agent + " just opened " + shop.shopName + ", rendering snapshot...");
