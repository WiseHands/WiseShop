...
class TemplateInstanceBase extends templateInstanceBase {
  constructor(props) {
    ...
    let children = []; /** @suppress {invalidCasts} */
    this.children = /** @type {!NodeList} */children; // Polymer 1.x did not use `Polymer.dom` here so not bothering.
...
var hideTemplateControls = {
  hideElementsGlobally: hideElementsGlobally
};
...
class CustomStyle extends HTMLElement {
  ...
  getStyle() {
    ...
    if (include) {
      style.removeAttribute(attr); /** @suppress {deprecated} */
...
var wiseShoppingCartItem = {
  WiseShoppingCartItem: WiseShoppingCartItem
};
...
var wiseShoppingCart = {
  WiseShoppingCart: WiseShoppingCart
};
...
class WiseShoppingCartContainer extends PolymerElement {
                        ...
                        <div hidden="[[!areThereItems(cart.items)]]" class="order-details-container">
                            <div class="order-details">
                                ...
                                <div class="total-container">
                                    ...
                                    <paper-spinner active="{{isMakeOrderRequestRunning}}">"{{!isMakeOrderRequestRunning}}","[[!isMakeOrderRequestRunning]]"</paper-spinner>
                                </div>
                            </div>
                        </div>
                    </div>
  ...
  _onLastResponseChanged(event, response) {
    ...
    this.set('cart', cartData ? cartData : {
      items: []
    });
  }
