angular.module('WiseHands')
  .controller('SelfTakeTranslationController', ['$scope', '$http', '$location', 'sideNavInit', '$routeParams', function ($scope, $http, $location, sideNavInit, $routeParams) {
    // $scope.loading = true;
      ...
      $http({
          ...
          .then((response) => {
              ...
              $scope.uuid= $scope.data.selfTakeTranslationBucket.translationList;
              $scope.content = $scope.data.selfTakeTranslationBucket.translationList;
