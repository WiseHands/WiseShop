angular.module('WiseHands')
  .controller('PaymentCashTranslationController', ['$scope', '$http', '$location', 'sideNavInit', '$routeParams', function ($scope, $http, $location, sideNavInit, $routeParams) {
    // $scope.loading = true;
      ...
      $http({
          ...
          .then((response) => {
              ...
              $scope.uuidList = $scope.data.manualPaymentTitleTranslationBucket.translationList;
              $scope.content = $scope.data.manualPaymentTitleTranslationBucket.translationList;
              $scope.translationUuid = response.data.manualPaymentTitleTranslationBucket.uuid;
